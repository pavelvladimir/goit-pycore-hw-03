      ...
      <main className={styles.page}>
        <section className={styles.hero}>
          <div className={styles.heroCopy}>
            ...
            <h1>One docs site for tasks, usage guides, and API reference.</h1>
            <p className={styles.lead}>
              This project combines Docusaurus for the main docs experience and
              Sphinx for API pages generated from Python docstrings.
            </p>
